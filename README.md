...
3. In the `custom_components` directory (folder) create a new folder called `exchangerate_host`.
4. Download _all_ the files from the `custom_components/exchangerate_host/` directory (folder) in this repository.
5. Place the files you downloaded in the new directory (folder) you created.
6. Restart Home Assistant
7. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "ExchangeRate.host"
